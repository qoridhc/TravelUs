    ...
    <div className="w-full h-full bg-[#EFEFF5]">
      <div className="w-full h-full flex flex-col justify-center items-center">
        <div className="w-full h-[50%] flex flex-col justify-between items-center">
          <div className="w-[90%] h-[78%] flex flex-col items-center justify-around rounded-xl bg-white">
            <p className="text-2xl font-bold">All-In-One 로그인</p>
            <div className="w-[85%] h-[50%] flex flex-col justify-around text-zinc-500">
          ...
          <div className="w-[90%] h-[18%] flex items-center justify-around rounded-xl bg-white">
            <div className="flex w-[58%] justify-around items-center">
              <p className="text-sm font-bold">계정이 없으신가요?</p>
              <button className="text-[#0046FF] font-bold">가입하기</button>
            </div>
          </div>
        </div>
      </div>
