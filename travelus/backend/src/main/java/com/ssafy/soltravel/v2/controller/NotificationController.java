...
public class NotificationController {
    ...
    public ResponseEntity<ResponseDto> setToken(@RequestBody PostTokenReq postTokenReq) {
        ResponseDto responseDto = notificationService.saveFcmToken(postTokenReq);
    ...
    @PostMapping("/test")
    public ResponseEntity<?> pushFcm(@RequestBody NotificationRequestDto requestDto) {
