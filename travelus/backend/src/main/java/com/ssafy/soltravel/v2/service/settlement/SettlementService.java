...
public class SettlementService {
    ...
    public String registerPersonalSettlement(PersonalSettlementRegisterRequestDto requestDto) {
        ...
        for (SettlementParticipantRequestDto request : participants) {
            ...
            PersonalSettlementHistory history = PersonalSettlementHistory.createPersonalSettlementHistory(id,
                participant, group,
                request.getAmount(), now);
            personalSettlementHistoryRepository.save(history);

            //TODO: 알림 보내기
            notificationService.sendPersonalSettlementNotification(history);
    ...
    public List<PersonalSettlementDto> getPersonalSettlementHistory(PersonalSettlementHistoryRequestDto requestDto) {
        ...
        List<PersonalSettlementHistory> response = personalSettlementHistoryRepository.findByUserIdAndSettlementStatus(
            userId,
    ...
    public List<GroupSettlementResponseDto> getGroupSettlementHistory(GroupSettlementHistoryRequestDto requestDto) {
        ...
        List<PersonalSettlementHistory> settlementHistories = personalSettlementHistoryRepository.findByGroupIdGroupedById(
        ...
        return groupedBySettlementId.entrySet().stream()
            .map(entry -> {
                ...
                List<PersonalSettlementHistoryDto> participants = settlementMapper.toPersonalSettlementHistoryDtoList(
                    groupedHistories);
    ...
    public ResponseEntity<List<TransferHistoryResponseDto>> postPersonalSettlementTransfer(
        ...
        long participantId = requestDto.getParticipantId();
        PersonalSettlementHistory history = personalSettlementHistoryRepository.findByIdAndParticipantId(historyId,
                participantId)
