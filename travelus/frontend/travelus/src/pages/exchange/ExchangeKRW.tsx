      ...
      <div className="h-full p-5 pb-8 flex flex-col">
        ...
        <div className="mb-6">
          <div className="mb-4 flex justify-between">
            ...
            <p className="text-lg">
              {inputAmount} USD → {calculatedKRW} KRW
            </p>
          </div>
        ...
        <div className="bg-gray-100 rounded-lg p-4 mb-4">
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center">
              <img src="/assets/flag/flagOfKRW.png" alt="KRW Flag" className="w-6 h-4 mr-2" />
              <span>대한민국 원</span>
            </div>
            <div>{parseFloat(calculatedKRW).toLocaleString()} KRW</div>
          </div>
          <p className="text-sm text-gray-500">현재 잔액: {selectedAccount.krwBalance.toLocaleString()} KRW</p>
        </div>

        <div className="bg-gray-100 rounded-lg p-4">
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center">
              <img src="/assets/flag/flagOfUSD.png" alt="USD Flag" className="w-6 h-4 mr-2" />
              <span>미국 달러</span>
            </div>
            <div className="flex items-center">
              <input
          ...
          <p className="text-sm text-gray-500">현재 잔액: {selectedAccount.usdBalance.toLocaleString()} USD</p>
        </div>
      </div>
