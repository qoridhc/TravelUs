...
const ExchangeDetail: React.FC = () => {
  ...
  return (
    <div className="container mx-auto max-w-md h-full p-5 pb-8 flex flex-col justify-between">
      <div className="grid gap-5">
        <button onClick={() => navigate(-1)} className="flex items-center text-blue-600 mb-4">
          <ChevronLeft className="mr-1 text-2xl text-[#565656]" />
        </button>
        ...
        {activeTab === "exchange" && (
          <>
            <div className="bg-gray-100 rounded-md p-4 mb-6">
              <h2 className="text-2xl font-semibold mb-2">{exchangeData.exchangeRate.toFixed(2)}원</h2>
              <p className="text-red-500">전일대비 {(exchangeData.exchangeRate - 1340).toFixed(2)}원 ▲</p>
            </div>
